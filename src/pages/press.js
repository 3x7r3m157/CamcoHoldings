...
const Press = () => {
  return (
    <div className="container">
      ...
      <h3 className="heading-center heading-cta">200m Pledge to Goodwill</h3>
      ...
      <h3 className="heading-center heading-cta">Akimel 7</h3>
      <div className="press-section">
      ...
      <h3 className="heading-center heading-cta">Chief Executive Officer of CamCo</h3>
      <div className="press-section">
